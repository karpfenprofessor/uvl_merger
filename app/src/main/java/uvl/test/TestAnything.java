...
public class TestAnything {
    ...
    public static void main(String[] args) throws Exception {
        String filePathString = "uvl/smartwatch/miband1.uvl";	 
        String filePathString2 = "uvl/smartwatch/miband1s.uvl";	   
        ...
        System.out.println(Analyser.returnNumberOfSolutions(recModel2));
        ...
        System.out.println(Analyser.returnNumberOfSolutions(unionModel));
    }
} 