...
public class AsiaFishModel extends BaseModel {
    ...
    public AsiaFishModel() {
        ...
        fishFamily = model.intVar("fishFamily", 0, 3); // Cyprinidae: 0, Scombridae: 1, Lutjanidae: 2, Cichlidae: 3
        fishSpecies = model.intVar("fishSpecies", 0, 7); // Grass Carp: 0, Silver Carp: 1, Yellowfin Tuna: 2, Skipjack
                                                         // Tuna: 3, Red Snapper: 4, Flame Snapper: 5, Tilapia: 6,
                                                         // Discus: 7
