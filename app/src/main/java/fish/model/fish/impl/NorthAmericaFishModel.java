...
public class NorthAmericaFishModel extends BaseFishModel {
        ...
        private void addLogicalConstraints() {
                 ...
                 * model.arithm(habitat, "=", 1));
                 * 
                 * // Constraint 6: Small Ictaluridae like Channel Catfish are primarily
                 * herbivores
                 ...
                 * model.or(model.arithm(habitat, "=", 0), model.arithm(habitat, "=", 1)));
                 * 
                 * // Constraint 9: Medium-sized Centrarchidae like Largemouth Bass are
                 * carnivorous
                 ...
                 * model.ifThen(model.and(model.arithm(fishSpecies, "=", 5),
                 * model.arithm(habitat, "=", 1)),
                 * model.arithm(diet, "=", 2));
                 * 
                 * // Constraint 22: Freshwater environments are unlikely to host large
                 * carnivorous
                 * // fish
                 * model.ifThen(model.and(model.arithm(size, "=", 2), model.arithm(habitat, "=",
                 * 0)),
                 * model.arithm(diet, "!=", 2));
                 * 
                 * // Constraint 23: Omnivorous diet common among all Centrarchidae regardless
                 * of
                 * // size
                 * model.ifThen(model.arithm(fishFamily, "=", 3),
                 * model.arithm(diet, "=", 1));
                 ...
                 * // large
                 * model.ifThen(model.and(model.arithm(diet, "=", 2), model.arithm(habitat, "=",
                 * 0)),
                 * model.or(model.arithm(size, "=", 1), model.arithm(size, "=", 2)));
                 * 
                 * // Constraint 28: Herbivores in saltwater are typically small
                 * model.ifThen(model.and(model.arithm(diet, "=", 0), model.arithm(habitat, "=",
                 * 1)),
                 * model.arithm(size, "=", 0));
                 * 
                 * // Constraint 29: Large fish species in freshwater are omnivorous or
                 * carnivorous
                 * model.ifThen(model.and(model.arithm(size, "=", 2), model.arithm(habitat, "=",
                 * 0)),
                 ...
                 * model.arithm(diet, "!=", 0));
                 * 
                 * // Constraint 32: Medium-sized freshwater fish are not exclusively
                 * carnivorous
                 * model.ifThen(model.and(model.arithm(size, "=", 1), model.arithm(habitat, "=",
                 * 0)),
                 * model.arithm(diet, "!=", 2));
