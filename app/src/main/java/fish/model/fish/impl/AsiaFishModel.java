...
public class AsiaFishModel extends BaseFishModel {
        ...
        public AsiaFishModel(boolean addConstraints, int number) {
                ...
                fishSpecies = model.intVar("fishSpecies", 16, 23); // Grass Carp: 0, Silver Carp: 1, Yellowfin Tuna: 2,
                                                                   // Skipjack
                                                                   // Tuna: 3, Red Snapper: 4, Flame Snapper: 5,
                                                                   // Tilapia:
                                                                   // 6,
                                                                   // Discus: 7
         ...
         * model.arithm(diet, "=", 0));
         * 
         * // Constraint 8: Carnivorous diet common in saltwater species like Red
         * Snapper
         ...
         * model.and(model.arithm(habitat, "=", 1), model.arithm(diet, "=", 2)));
         * 
         * // Constraint 18: Freshwater habitats predominantly host small to
         * medium-sized
         * // fish
         ...
         * model.arithm(habitat, "=", 1));
         * 
         * // Constraint 22: Medium and large fish in freshwater are generally
         * omnivorous
         * model.ifThen(model.or(model.arithm(size, "=", 1), model.arithm(size, "=",
         * 2)),
         ...
         * model.arithm(diet, "!=", 2));
         * 
         * // Constraint 24: Small fish in saltwater environments are primarily
         * herbivorous
         * model.ifThen(model.and(model.arithm(size, "=", 0), model.arithm(habitat, "=",
         * 1)),
         * model.arithm(diet, "=", 0));
         * 
         * // Constraint 25: Medium-sized herbivores like Tilapia are common in
         * freshwater
         * model.ifThen(model.and(model.arithm(fishSpecies, "=", 6), model.arithm(size,
         * "=", 1)),
         * model.and(model.arithm(habitat, "=", 0), model.arithm(diet, "=", 0)));
         * 
         ...
         * 
         * // Constraint 33: Omnivores are found across all size categories in
         * freshwater
         * model.ifThen(model.arithm(habitat, "=", 0),
         ...
         * model.arithm(diet, "=", 1));
         * 
         * // Constraint 38: Freshwater environments predominantly host herbivorous
         * species
         * model.ifThen(model.arithm(habitat, "=", 0),
         * model.arithm(diet, "=", 0));
         * 
         ...
         * // saltwater
         * model.ifThen(model.and(model.arithm(fishSpecies, "=", 2), model.arithm(size,
         * "=", 2)),
         * model.and(model.arithm(habitat, "=", 1), model.arithm(diet, "=", 2)));
         */
