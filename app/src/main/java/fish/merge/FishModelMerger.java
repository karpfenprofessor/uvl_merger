...
public class FishModelMerger {

    protected final static Logger logger = LogManager.getLogger(FishModelMerger.class);
    ...
    private static void mergeVariables(BaseFishModel baseModel1, BaseFishModel baseModel2,
            BaseFishModel baseMergedModel,
