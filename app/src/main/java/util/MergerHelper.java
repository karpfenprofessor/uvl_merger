...
public class MergerHelper {
    ...
    public static void handleRegionFeature(final RecreationModel unionModel, final RecreationModel[] models,
        ...
        logger.debug("\t[handleRegionFeature] create unified Region structure with regions: {}", regionStrings);
    ...
    public static void handleRootFeature(final RecreationModel unionModel, final RecreationModel... models) {
        // Set root feature for union model
